      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                String className = labelList.get((int) class_value);
                ...
                Imgproc.putText(rotated_mat_image, labelList.get((int) class_value)+" "+ Float.toString(score_value),new Point(left,top),3,1,new Scalar(255, 0, 0, 255),2);
                // Print or display the information about the detected object
                Log.d("Detected Object: " , labelList.get((int) class_value));
                System.out.println("Detected Object: " + className);
                System.out.println("Score: " + score_value);
                System.out.println("Bounding Box: (" + left + ", " + top + ") - (" + right + ", " + bottom + ")");
            }
